...
gdown "1fXjUHRt4nMDVvPN-7txPDZDs4nsbe9SU" -O $MODEL_DIR/model1_delay_regressor_v2.pkl
gdown "11Tim9EpymUctMMPhy4eo8oNvjhg2Rmeo" -O $MODEL_DIR/model1_corridor_encoder_v2.pkl
